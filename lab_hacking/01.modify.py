...
class Tab1(QWidget):
    ...
    def update_vote(self):
        ...
        print(self.vote_list[self.current_vote_id]['total_vote'])
        print(self.vote)
        ...
        self.option3_button.setText(self.vote_list[self.current_vote_id]['quesition'])
...
class Tab2(QWidget):
    def __init__(self,devs):
        ...
        self.clear_button.clicked.connect(self.publish_button)
